        ...
        <div className="flex items-center space-x-space-sm lg:space-x-space-lg">
          <nav className="hidden lg:flex items-center space-x-space-lg">
            {navLinks.map((link) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  `font-label-lg text-label-lg uppercase transition-colors py-2 border-b-2 ${
                    isActive
          ...
          <div className="flex items-center space-x-space-md lg:pl-space-md lg:border-l border-outline-variant/40">
            ...
            <button
              ...
              className="lg:hidden inline-flex items-center justify-center w-10 h-10 rounded-DEFAULT border border-outline-variant/40 text-primary"
            >
          ...
          <div className="px-margin-mobile py-space-sm flex flex-col">
            {navLinks.map((link) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  `font-label-lg text-label-lg uppercase py-space-md border-b border-outline-variant/30 last:border-b-0 transition-colors ${
            ...
            <NavLink
              to="/contact"
              onClick={() => setOpen(false)}
              className="mt-space-md inline-flex items-center justify-center bg-primary text-on-primary font-label-md text-label-md uppercase tracking-wider px-space-lg py-3 rounded-DEFAULT"
            >
              Contact Us
            </NavLink>
          </div>
